...
// the two strings starting from index 0. For each match, add one point to userScore. 
// Upon a mismatch, exit the loop using a break statement. Assume simonPattern and userPattern 
